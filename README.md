...
*   **深度响应式布局 2.0**：新增「自适应多行工具栏」，窗口缩小时功能按钮自动平滑换行。通过像素级高度追踪技术，确保抽屉面板始终与工具栏完美对齐，为您保留最舒适的设计视口。
*   **快捷剪断连接线 (Ctrl + 右键)**：新增专业级“剪刀”工具。按住 `Ctrl` 并在画布上通过鼠标右键划过连接线，即可瞬间精准切断，操作效率比双击断开提升 300%。
