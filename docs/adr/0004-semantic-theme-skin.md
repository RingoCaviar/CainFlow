...
During ticket #56, legacy theme-qualified button and toggle rules remain only as an inert, hash-guarded migration baseline. The later cascade-owned feature skin is authoritative; ticket #57 removes that frozen baseline after the complete settings matrix is accepted. No new theme exception is allowed during this interval.
